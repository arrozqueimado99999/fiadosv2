...
const BtnLink = ({ icon, text, to, isActive }) => {
  ...
  const defaultClasses = 'duration-75 px-4 flex gap-2 flex-row font-bold text-neutral-700 items-center p-2 rounded-full w-full border-transparent border-2 hover:border-neutral-300';
